-- ============================================
-- FIX DEFINITIVO: Funzioni recensioni con JOIN corretti
-- ============================================
...
-- ============================================
-- STEP 2: Crea funzioni con JOIN corretti
-- ============================================
...
BEGIN
    ...
    SELECT 
        ...
        ir.reviewer_id,
        CASE 
            WHEN ir.reviewer_type = 'institute' THEN COALESCE(i.institute_name, 'Istituto')
            WHEN ir.reviewer_type = 'private' THEN COALESCE(pu.username, 'Utente')
            ELSE 'Utente'
        END as reviewer_name,
        CASE 
            WHEN ir.reviewer_type = 'institute' THEN i.logo_url
    ...
    LEFT JOIN institutes i ON ir.reviewer_id = i.id AND ir.reviewer_type = 'institute'
